...
function backwardDate() {
  ...
  <div style={{ display: "flex", alignItems: "center", marginBottom: "-10px", marginLeft: "-10px" }}>
   <div>    <h1 style={{ width: "300px", textAlign: "center", margin: 0}}>{monthNames[currentDate.getMonth()]} {currentDate.getFullYear()}</h1>
  </div>
        ...
        daysInWeek.map((day,index ) => {
          ...
          const  isToday = dateForDay.toDateString() === today.toDateString();
            ...
            return <th style={{ textAlign: "center", 
               backgroundColor:  isToday ? "lightblue" : "white" }} key={day}>
     ...
     {hoursInDay.map((hour, hourIndex) => {
        ...
        return <tr key={hour + hourIndex}>
          ...
          const  isToday = dateForDay.toDateString() === today.toDateString();
            ...
            return <td key={day + hourIndex} style={{ 
               backgroundColor:  isToday ? "lightblue" : "white" }}></td>
            }
         )}
